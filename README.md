...
I am an associate professor in the Department of Statistics at Jeonbuk National University. I received my Ph.D. in 2018 from the Department of Statistics at Seoul National University, under the supervision of Professor Hee-Seok Oh. My primary research area is multiscale methodology, which aims to represent and analyze data across different levels of resolution or abstraction. This perspective allows for multiple interpretations of the same data, and depending on the scale of observation, the resulting conclusions can vary—a phenomenon exemplified by Simpson’s paradox. Traditional multiscale methods, such as Fourier and wavelet transforms, are typically built on the assumption of Euclidean structure. However, the core idea of multiscale methodology is not inherently tied to Euclidean space. At its heart, it is about using hierarchical observation tools to interpret data, regardless of the underlying data structure.
In this sense, multiscale thinking is more fundamental and abstract than its classical implementations may suggest. My current research focuses on developing multiscale methodologies for non-Euclidean data, such as graphs and manifolds. This line of work is not merely an extension of existing techniques but an attempt to explore the essence of multiscale ideas in a more general and principled way. It also aligns with recent developments in areas like graph signal processing and geometric deep learning, where such non-Euclidean structures are increasingly important.
