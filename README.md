...
More recently, I’ve been focusing on multiscale methodology for non-Euclidean data, such as graphs and manifolds. While classical multiscale techniques—like Fourier and wavelet transforms—are mostly developed for Euclidean domains, the underlying idea of multiscale analysis is much broader. It is not tied to the geometry of the data, but to how we structure our observations. That’s why developing multiscale methods for non-Euclidean domains is not just a technical extension, but a deeper exploration of what multiscale analysis really means. For me, this is the most exciting part—it pushes us to rethink the foundations of multiscale thinking itself. As a bonus, this line of research also aligns with emerging fields like graph signal processing and geometric deep learning, where non-Euclidean structures are naturally encountered.
