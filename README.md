...
I am an associate professor in the Department of Statistics at Jeonbuk National University. I received my Ph.D. in 2018 from the Department of Statistics at Seoul National University, under the supervision of Professor Hee-Seok Oh. My research area is multiscale methodology, which aims to represent and analyze data from multiple levels or scales. I find multiscale thinking fascinating because it allows us to observe the same data from different perspectives, often leading to new insights. Sometimes, changing the scale of observation can even reverse the conclusion—an effect well illustrated by Simpson’s paradox. The idea of using hierarchical observation tools to interpret data reveals the richness and complexity of statistical reasoning, and that’s what makes multiscale methods so interesting to me.

More recently, I’ve been focusing on multiscale methodology for non-Euclidean data, such as graphs and manifolds. While classical multiscale techniques—like Fourier and wavelet transforms—are typically built for Euclidean data, the core concept of multiscale analysis is actually more general. It is not tied to any specific data structure, but rather to how we observe and decompose information across levels. That’s why developing multiscale methods for non-Euclidean domains is not just a technical extension, but a deeper exploration of what multiscale analysis really means. This direction is especially exciting because it connects naturally with active research fields like graph signal processing and geometric deep learning, where the data is inherently irregular or unstructured.
